    ...
    return ( 
        <div className='container '>
             <div className='row p-4 border-bottom'>
                <h1 className='text-center p-5 mb-5 fs-3 '>
                   We pioneered the discount broking model in India.<br/>
                   Now, we are breaking ground with our technology.
                </h1>
             </div>
             <div className='row mt-5 p-4 about-para ' style={{lineHeight:"1.8",fontSize:"1.1em"}}>
                  ...
                  <div className='col-6 p-5 text-muted'>
                       ...
                       <p className='mb-4 '>
                         ...
                         learn more about our business and product <a href="" style={{textDecoration:"none"}}>
                            philosophies</a>.
                       </p>
                  </div>
             </div>
